...
## REST Client equivalents

The folder also contains REST Client versions of the same examples:

- `demo_product_collection.http`
- `demo_product_az.http`
- `demo_custom_resource_collection.http`

For a step-by-step explanation of how these requests map to `fetch`, see [docs/prestashop_fetch_equivalents.md](../docs/prestashop_fetch_equivalents.md).